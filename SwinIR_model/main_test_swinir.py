...
def main():
    ...
    args.model_path = _resolve_project_path(args.model_path)
    args.folder_lq = _resolve_project_path(args.folder_lq)
    args.folder_gt = _resolve_project_path(args.folder_gt)
...
def setup(args):
    ...
    save_dir = str((PROJECT_ROOT / save_dir).resolve())
